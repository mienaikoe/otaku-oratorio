label scene8:
    ...
    play sound "thunderbolt.mp3"
    play music "rain_ending.mp3"
    ...
    child_akira  "(eyes fading) Suisei, I… love…"

    teen_akira "(chortles) Love. Love is no longer needed here."
